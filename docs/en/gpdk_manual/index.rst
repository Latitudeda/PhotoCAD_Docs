...
**gpdk** is a package for creating parametric device layout units based on Python scripts in the PhotoCAD platform. Install or upgrade the gpdk package by placing the ``gpdk-x.x.x-py3-none-any.whl`` file in the ``.python>.pypi_cache`` folder.
